...
import { WBTC, SOCKS } from 'src/constants/tokens'
...
const SOCKS_CURRENCY_ID = idFromCurrency(SOCKS).toLowerCase();
...
export const initialFavoritesState: FavoritesState = {
  tokens: [ETH_CURRENCY_ID, WBTC_CURRENCY_ID, SOCKS_CURRENCY_ID],
